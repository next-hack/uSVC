...
FRESULT pf_open (const char* path, uint8_t*dirBuffer, uint8_t useLargeBuffer);							/* Open a file */
...
FRESULT pf_opendir (DIR* dj, const char* path, uint8_t *dirBuffer, uint8_t useLargeBuffer);				/* Open a directory */
FRESULT pf_readdir (DIR* dj, FILINFO* fno, uint8_t *dirBuffer, uint8_t useLargeBuffer);					/* Read a directory item from the open directory */
