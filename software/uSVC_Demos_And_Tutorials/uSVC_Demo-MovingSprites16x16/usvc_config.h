...
// note: if using meta tiles, vramy and vramx size should be a multiple of 2.
	...
	#define MAX_TILES (261 + 70)  // adjust this according to the number of tiles
#endif
...
#define MAX_TEMP_SPRITE_TILES 261		// Be sure to set also MAX_TILES large enough!
#define MAX_ONSCREEN_SPRITES 29			// Number of actual sprites on screen
