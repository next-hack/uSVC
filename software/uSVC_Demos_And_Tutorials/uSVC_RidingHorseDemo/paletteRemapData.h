...
#define LEVEL0_NUMBER_OF_PALETTES 2
#define LEVEL0_COLOR_REMAP_ROWS 489
#define LEVEL0_NUMBER_OF_REMAP_CHECKPOINTS 6 
extern const uint16_t level0_checkpointData[LEVEL0_NUMBER_OF_REMAP_CHECKPOINTS * 16 * 2];
extern const uint8_t level0_rowPaletteIndexes[LEVEL0_COLOR_REMAP_ROWS];
extern const uint8_t level0_colorToChangeIndex[LEVEL0_COLOR_REMAP_ROWS];
extern const uint8_t level0_newColorTable[LEVEL0_COLOR_REMAP_ROWS];
extern const int16_t level0_paletteRowRemap[];
