...
#include "../usvc_kernel/include/samd21.h"

/* Initialize segments */
extern const uint32_t functionVector[];
...
const DeviceVectors exception_table = {
        ...
        .pvReserved28           = (void*) &functionVector         /* 28 Reserved */			// (NEXT-HACK) This vector is not used, so we put here the address of array of functions.
};
...
#if defined(ID_USB)
//		   Note to Atmel/Microchip: please stop using multiple bitfield accesses, otherwise the code will become huge. Use the .reg instead, and some "|".
//			changing the following lines with the second one, will save 16 bytes!
//         USB->DEVICE.QOSCTRL.bit.CQOS = 2;
//         USB->DEVICE.QOSCTRL.bit.DQOS = 2;
			USB->DEVICE.QOSCTRL.reg = USB_QOSCTRL_CQOS(USB_QOSCTRL_CQOS_MEDIUM_Val) | USB_QOSCTRL_DQOS(USB_QOSCTRL_DQOS_MEDIUM_Val);
#endif
